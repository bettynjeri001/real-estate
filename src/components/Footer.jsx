        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="./pages/ContactPage" className="hover:text-gray-600 transition-colors">
                  info@addresly.com
                </a>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 rounded-full bg-gray-800 hover:bg-gray-400 transition-colors">
                <FaFacebook size={20} />
              </a>
              <a href="#" className="p-2 rounded-full bg-gray-800 hover:bg-gray-400 transition-colors">
                <FaTwitter size={20} />
