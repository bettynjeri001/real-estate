            ...
            <NavLink
              ...
              className={({ isActive, isPending }) =>
                isPending
                  ? "pending"
                  : isActive
                  ? "font-bold text-[#03a9fc] underline"
                  : ""
              }
            >
              Home
            ...
            <NavLink
              ...
              className={({ isActive, isPending }) =>
                isPending
                  ? "pending"
                  : isActive
                  ? "font-bold underline text-[#03a9fc]"
                  : ""
              }
            >
              All Properties
        ...
        <div className="navbar-end">
          <div className="mr-2">
            {user ? (
              <div className="flex gap-2 md:gap-4">
                ...
                <div className="dropdown dropdown-end">
                  <div className="flex gap-3">
                    <label tabIndex={0}>
                      {user.photoURL ? (
                        <img
                          className="w-8 md:w-14 md:h-14 rounded-full"
                          src={user.photoURL}
                          alt=""
                        />
                      ) : (
                    ...
                    <div className="p-3">
                      ...
                      <div className="text-center">
                        <h2 className="text-sm md:text-xl mb-2">
                          <span className="text-[#03a9fc]">Name:</span>{" "}
                          {user.displayName}
                        </h2>
                        <p className="text-sm  md:text-lg mb-5 ">
                          <span className="text-[#03a9fc]">Email:</span>{" "}
                          {user.email}
                        </p>
                      </div>
                    </div>
                ...
                <Link to="/login" className="flex items-center">
                  <button
                    ...
                    className="bg-[#03a9fc] border-0 text-white p-2 rounded-lg"
                  >
                    <LuLogOut></LuLogOut>
                  </button>
                </Link>
              ...
              <>
                <Link to="/login">
                  <button className="bg-[#03a9fc] border-0 text-white p-2 md:p-3 px-1 md:px-4 rounded-lg text-sm md:text-xl">
                    Login
                  </button>
                </Link>
              </>
